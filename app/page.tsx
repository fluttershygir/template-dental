...
import { CheckCircle2, Phone, ArrowRight, Heart, Star, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans">
      ...
      <section className="py-12 bg-slate-900/50 border-y border-slate-800">
        <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {(["Insurance Accepted", "Emergency Care", "5-Star Rated", "Family Friendly"] as string[]).map((label, i) => (
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {([
              { title: "General Dentistry", desc: "Routine checkups, cleanings, and digital x-rays to maintain optimal oral health.", icon: Star },
              { title: "Cosmetic Dentistry", desc: "Teeth whitening, veneers, and bonding to help you achieve your dream smile.", icon: Sparkles },
              { title: "Restorative Care", desc: "Crowns, bridges, and implants to restore function and confidence to your smile.", icon: CheckCircle2 },
              ...
              <Card key={i} className="bg-slate-900 border-slate-800 hover:border-cyan-500/50 transition-colors group">
                <CardHeader>
                  <div className="w-12 h-12 rounded-lg bg-slate-800 text-cyan-400 flex items-center justify-center mb-4">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center text-sm font-medium text-cyan-400 cursor-pointer">
